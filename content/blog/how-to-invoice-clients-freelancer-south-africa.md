...
keywords: ["freelancer invoice South Africa", "invoice checklist", "how to invoice clients", "ZAR invoice template", "sole proprietor invoicing"]
cta:
  eyebrow: InvoiceFast
  title: Send professional PDF invoices with less admin
  primaryHref: https://app.aurastudioza.com/sign-up
  primaryLabel: Start InvoiceFast trial
...
Agree **scope and price** in writing (email is fine). For corporate clients, state whether a quote is **VAT inclusive or exclusive** — ambiguity causes rejected invoices. The free [VAT calculator](/vat-calculator) helps when you need to split amounts quickly.
...
Templates beat reinventing Word each month. [InvoiceFast](/invoicefast) gives you a live builder, PDF export, history, and ZAR-friendly defaults — with a free tier after trial if you want to try before subscribing.
