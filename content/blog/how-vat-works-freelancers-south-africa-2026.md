...
keywords: ["VAT South Africa", "freelancer VAT", "VAT checklist", "sole proprietor South Africa", "invoice VAT"]
cta:
  eyebrow: Free tool
  title: Work out VAT on a quote or invoice in seconds
  primaryHref: /vat-calculator
  primaryLabel: Open VAT calculator
  secondaryHref: /invoicefast
  secondaryLabel: Explore InvoiceFast
---

Many South African freelancers eventually deal with VAT — especially as turnover grows or when corporate clients expect proper tax invoices. This article is a **starter checklist**, not tax advice. Thresholds, filing periods, and your obligations depend on your registration status. Check [sars.gov.za](https://www.sars.gov.za) or a registered tax practitioner before you make decisions.
...
- **Use tools for consistency** — the free [VAT calculator](/vat-calculator) helps split inclusive/exclusive amounts; [InvoiceFast](/invoicefast) helps produce professional PDF invoices with the fields clients expect.
